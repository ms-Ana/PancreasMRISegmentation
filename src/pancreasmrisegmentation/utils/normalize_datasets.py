...
@click.option(
    ...
    type=str,
    required=False,
    help="Path to the output directory where the converted .nii.gz files will be saved. When not provided, the converted files will be saved in the same directory as the input files.",
)
